        ...
        <div class="row">
            ...
            <div class="col-md-6" style="margin-top: 248px;">
                <div>
                    <div>
                        <div>
                            <p class="login-text">Verify your One-Time Password (OTP)
                                <span>&#10003;</span></p>
                            <form action="login_validation.php" method="post">
                            <div>
                                <p>Please enter your OTP that we have sent to your email account.</p>
                            ...
                            <div style="background: #dddddd;border-radius: 25px;border-style: none;width: 360px;margin-top: 10px;">
                                ...
                                <input required oninvalid="this.setCustomValidity('Please input valid otp')" oninput="setCustomValidity('')" type="number" style="padding: 2px 2px;margin: -1px;width: 289px;color: rgb(123,123,123);background: #dddddd;border-width: 48px;border-style: none;border-top-style: none;border-right-style: none;border-bottom-style: none;border-left-style: none;" placeholder="Enter OTP" name="otp" required="">
                            </div>
                            <div style="background: var(--bs-teal);border-radius: 25px;margin-top: 10px;margin-bottom: 15px;width: 360px;">
                                <button class="btn login-button" type="submit" name="otpButton">Submit</button>
                            </div>
                            </form>
                            <p class="error-text">
                            <?php  
