...
id_counter = 'SELECT id FROM products group by id '



#get id for iteration of file and select query 
sql2 = 'SELECT product_id FROM sales GROUP BY product_id'
cur.execute(sql2)
p_id_fetch = cur.fetchall()
id_count = cur.rowcount
#declare dictionaries for each product
totalDic = {}
last_array = {}
mape = {}

for p_id in p_id_fetch:
