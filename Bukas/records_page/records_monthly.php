...
?>
            ...
            <div class="col">
                <header>
                    <div class="col d-flex justify-content-between align-items-md-center">
                        ...
                        <div>
                            <form action='../records_page/records_monthly.php' method="post">
                    ...
                    <div>
                        <form action="../records_page/export_monthly.php" method="post">
                            <div role="group" class="btn-group">
                                <button class="btn btn-primary pdf <?php if(isset($_POST['date_id'])){echo "";}else{ echo "disabled";} ?>" type="button" onclick="generatePDFM()" style="background: #d94444;border-style: none;">PDF</button>
                            ...
                            <tr>
                            	<?php 
                            		if(isset($_POST['date_id'])){
                                        ...
                                        $yr_month = substr($formatDate, 0, 7);

                                        $date_start = $formatDate.'01';
                                        $date_end = $formatDate.'31';

                                		$_SESSION['date_start'] = $date_start;
                                        $_SESSION['date_end'] = $date_end;
                                        $_SESSION['yr_month'] = $yr_month;

                                		$sales = join_sales_monthly_table($date_start, $date_end);
    ...
    <script src="assets/js/export_monthly.js"></script>
