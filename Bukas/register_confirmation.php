        ...
        <div class="row">
            ...
            <div class="col-md-6" style="margin-top: 248px;">
                <div>
                    <div>
                        <div>
                            <p class="login-text">Verify your Email
                                <span>&#10003;</span></p>
                            <form action="register_validation.php" method="post">
                            <div>
                                <p>Please enter the code that we have sent to your email account.<br>Please check your inbox or spam folder.</p>
                            </div>
                            <div style="background: #dddddd;border-radius: 25px;border-style: none;width: 360px;margin-top: 10px;">
                                ...
                                <input required oninvalid="this.setCustomValidity('Please input valid code')" oninput="setCustomValidity('')" type="number" style="padding: 2px 2px;margin: -1px;width: 289px;color: rgb(123,123,123);background: #dddddd;border-width: 48px;border-style: none;border-top-style: none;border-right-style: none;border-bottom-style: none;border-left-style: none;" placeholder="Enter Code" name="code" required="">
                            </div>
                            <div style="background: var(--bs-teal);border-radius: 25px;margin-top: 10px;margin-bottom: 15px;width: 360px;">
                                <button class="btn login-button" type="submit" name="codeButton">Submit</button>
                            </div>
                            </form>
                            <p class="error-text">
                            <?php  
